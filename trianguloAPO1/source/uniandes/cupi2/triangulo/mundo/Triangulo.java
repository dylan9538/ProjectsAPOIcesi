 ...
 /**
   ...
   return altura;
    ...
    public String metodo1( )
    {
    	...
    	//2. asigne a la variable que acaba de declarar el resultado de llamar el mŽtodo trasladarPunto1EnX
    	//3. modifique el String que est‡ en la instrucci—n de retorno, cambielo por: 
    	//  "La coordenada x del punto 1 despuŽs de ser tralsadado es: " + XXXX;
